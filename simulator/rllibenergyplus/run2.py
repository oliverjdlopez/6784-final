...
class EnergyPlusRunner:
    ...
    def __init__(self, episode: int, env_config: Dict[str, Any], obs_queue: Queue, act_queue: Queue) -> None:
        ...
        self.variables = {
            ...
            # °C
            "iat": ("Zone Mean Air Temperature", "MAIN ZONE"),
            ...
            "clg_spt": ("Schedule Value", "COOLING RETURN AIR SETPOINT SCHEDULE"),
            "htg_spt": ("Schedule Value", "HEATING SETPOINT SCHEDULE")
        }
...
class EnergyPlusEnv(gym.Env):
    ...
    def __init__(self, env_config: Dict[str, Any]):
        ...
        # observation space:
        # OAT, IAT, cooling setpoint, heating setpoint, HVAC elec, facility elec, building elec
        low_obs = np.array(
    ...
    def _compute_reward(obs: Dict[str, float]) -> float:
        ...
        reward = -(1e-7 * (obs["elec"] + obs["facility_elec"] + obs["building_elec"])) - tmp_rew
        return reward
